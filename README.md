...
- [libzip](http://www.nih.at/libzip) 1.7.3
...
Do not forget to also link against libzip libraries e.g. in *lib/libzip-1.7.3/lib/.libs/*).
...
1. Download [libzip](http://www.nih.at/libzip/libzip-1.7.3.tar.gz) and [zlib](http://zlib.net/zlib1211.zip) sources and extract them in the 'lib' folder.
  ...
  ```
2. Apply the modifications described in libzippp/lib/libzip-1.7.3-windows.patch.
